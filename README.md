...
```shell
npm install grunt-venusjs --save-dev
```

Once the plugin has been installed, it may be enabled inside your Gruntfile with this line of JavaScript:

```js
grunt.loadNpmTasks('grunt-venusjs');
```

## The "venusjs" task

### Overview
In your project's Gruntfile, add a section named `venusjs` to the data object passed into `grunt.initConfig()`.
